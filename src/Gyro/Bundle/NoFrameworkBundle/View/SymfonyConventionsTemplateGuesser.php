...
namespace Gyro\Bundle\NoFrameworkBundle\View;

use Gyro\Bundle\NoFrameworkBundle\Controller\QafooControllerNameParser;
...
class SymfonyConventionsTemplateGuesser implements TemplateGuesser
{
    ...
    /**
     * @var \Gyro\Bundle\NoFrameworkBundle\Controller\QafooControllerNameParser
     */
    private $parser;
