...
namespace Gyro\Bundle\NoFrameworkBundle\Tests\EventListener;

use PHPUnit\Framework\TestCase;
use Gyro\Bundle\NoFrameworkBundle\EventListener\ParamConverterListener;
use Gyro\Bundle\NoFrameworkBundle\ParamConverter\SymfonyServiceProvider;
...
class ParamConverterListenerTest extends TestCase
{
    ...
    {
        $this->assertRequestHasContext('\Gyro\Bundle\NoFrameworkBundle\Tests\EventListener\iAmAController');
    }
