...
namespace Gyro\Bundle\NoFrameworkBundle\Tests\DependencyInjection;

use PHPUnit\Framework\TestCase;
use Gyro\Bundle\NoFrameworkBundle\DependencyInjection\GyroNoFrameworkExtension;
...
class ContainerTest extends TestCase
{
    ...
    public function it_compiles_with_container()
    {
        ...
        $this->assertInstanceOf(
            'Gyro\Bundle\NoFrameworkBundle\Controller\ControllerUtils',
            $container->get('qafoo_labs_noframework.controller_utils')
        );

        $this->assertInstanceOf(
            'Gyro\Bundle\NoFrameworkBundle\EventListener\ViewListener',
            $container->get('qafoo_labs_noframework.view_listener')
        );

        $this->assertInstanceOf(
            'Gyro\Bundle\NoFrameworkBundle\EventListener\ParamConverterListener',
    ...
    public function it_allows_configuring_convert_exceptions()
    {
        ...
        $this->assertInstanceOf(
            'Gyro\Bundle\NoFrameworkBundle\EventListener\ConvertExceptionListener',
