...
namespace Gyro\Bundle\NoFrameworkBundle\Tests\View;

use PHPUnit\Framework\TestCase;
use Gyro\Bundle\NoFrameworkBundle\View\SymfonyConventionsTemplateGuesser;
...
class SymfonyConventionsTemplateGuesserTest extends TestCase
{
    ...
    {
        $this->bundleLocation = \Phake::mock('Gyro\Bundle\NoFrameworkBundle\View\BundleLocation');
        $this->parser = \Phake::mock('Gyro\Bundle\NoFrameworkBundle\Controller\QafooControllerNameParser');
